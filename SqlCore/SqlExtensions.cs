...
namespace SqlCore
{
    ...
    {
        public static async Task<string> GetSqlScript(this string query) =>
            await ($"SQL.{query}").GetTextFromEmbeddedResource();
        ...
        public static async Task<string> GetTextFromEmbeddedResource(this string resource)
        {
            ...
            {
                throw new Exception("The provided resource was not found");
            }
        }
